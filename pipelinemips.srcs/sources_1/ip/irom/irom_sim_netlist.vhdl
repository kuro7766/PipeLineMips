...
-- Date        : Tue Apr 20 20:25:46 2021
-- Host        : DESKTOP-ORPFHN7 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim {D:/6
--               pipelinemips/pipelinemips.srcs/sources_1/ip/irom/irom_sim_netlist.vhdl}
-- Design      : irom
...
\synth_options.dist_mem_inst\: entity work.irom_dist_mem_gen_v8_0_13_synth
     port map (
      a(9 downto 0) => a(9 downto 0),
      spo(12) => \^spo\(24),
      spo(11 downto 10) => \^spo\(29 downto 28),
      spo(9) => \^spo\(26),
